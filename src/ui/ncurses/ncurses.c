...
ncurses_setup(void){
	...
	if(setup_extended_colors() != OK){
		...
		assert(init_pair(LCAST_RES_COLOR,COLOR_CYAN_50,-1) == OK);
		...
		assert(init_pair(LCAST_ALTROW_COLOR,COLOR_CYAN,COLOR_PALEYELLOW) == OK);
		...
		assert(init_pair(LCAST_ALTROW_L3_COLOR,COLOR_CYAN_75,COLOR_PALEYELLOW) == OK);
		...
		assert(init_pair(LCAST_ALTROW_RES_COLOR,COLOR_CYAN_50,COLOR_PALEYELLOW) == OK);
