...
ncurses_setup(void){
	...
	if(setup_extended_colors() != OK){
		...
		assert(init_pair(LCAST_ALTROW_COLOR,COLOR_ORANGE,COLOR_PALEYELLOW) == OK);
		assert(init_pair(UCAST_ALTROW_COLOR,COLOR_CYAN,COLOR_PALEYELLOW) == OK);
		assert(init_pair(MCAST_ALTROW_COLOR,COLOR_BLUE,COLOR_PALEYELLOW) == OK);
		assert(init_pair(BCAST_ALTROW_COLOR,COLOR_PURPLE,COLOR_PALEYELLOW) == OK);
		assert(init_pair(LCAST_ALTROW_L3_COLOR,COLOR_ORANGE_75,COLOR_PALEYELLOW) == OK);
		assert(init_pair(UCAST_ALTROW_L3_COLOR,COLOR_CYAN_75,COLOR_PALEYELLOW) == OK);
		assert(init_pair(MCAST_ALTROW_L3_COLOR,COLOR_BLUE_75,COLOR_PALEYELLOW) == OK);
		assert(init_pair(BCAST_ALTROW_L3_COLOR,COLOR_PURPLE_75,COLOR_PALEYELLOW) == OK);
		assert(init_pair(LCAST_ALTROW_RES_COLOR,COLOR_ORANGE_50,COLOR_PALEYELLOW) == OK);
		assert(init_pair(UCAST_ALTROW_RES_COLOR,COLOR_CYAN_50,COLOR_PALEYELLOW) == OK);
		assert(init_pair(MCAST_ALTROW_RES_COLOR,COLOR_BLUE_50,COLOR_PALEYELLOW) == OK);
		assert(init_pair(BCAST_ALTROW_RES_COLOR,COLOR_PURPLE_50,COLOR_PALEYELLOW) == OK);
