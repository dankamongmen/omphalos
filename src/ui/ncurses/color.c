...
// Derived colors
#define RBRGREEN 0x58
#define GBRGREEN 0x58
#define BBRGREEN 0x58
...
#define GNOME5(x) ((x) / 20)
	...
	ret |= init_color(COLOR_BRGREEN,CURSES_RGB(RBRGREEN),CURSES_RGB(GBRGREEN),CURSES_RGB(BBRGREEN));
	...
	ret |= init_color(COLOR_PURPLE,CURSES_RGB(RVIOLET),CURSES_RGB(GVIOLET),CURSES_RGB(BVIOLET));
	ret |= init_color(COLOR_BGREEN,CURSES_RGB(RGREEN),CURSES_RGB(GGREEN),CURSES_RGB(BGREEN));
	...
	ret |= init_color(COLOR_PURPLE_75,CURSES75_RGB(RVIOLET),CURSES75_RGB(GVIOLET),CURSES75_RGB(BVIOLET));
	ret |= init_color(COLOR_BGREEN_75,CURSES75_RGB(RGREEN),CURSES75_RGB(GGREEN),CURSES75_RGB(BGREEN));
	...
	ret |= init_color(COLOR_PURPLE_50,CURSES50_RGB(RVIOLET),CURSES50_RGB(GVIOLET),CURSES50_RGB(BVIOLET));
	ret |= init_color(COLOR_BGREEN_50,CURSES50_RGB(RGREEN),CURSES50_RGB(GGREEN),CURSES50_RGB(BGREEN));
	ret |= init_color(COLOR_ORANGE_50,CURSES50_RGB(_ORANGE_R),CURSES50_RGB(_ORANGE_G),CURSES50_RGB(_ORANGE_B));
	ret |= init_color(COLOR_PALEORANGE,CURSES5_RGB(_ORANGE_R),CURSES5_RGB(_ORANGE_G),CURSES5_RGB(_ORANGE_B));
	...
	ret |= init_color(COLOR_PALEPURPLE,CURSES5_RGB(RVIOLET),CURSES5_RGB(GVIOLET),CURSES5_RGB(BVIOLET));
	ret |= init_color(COLOR_PALEYELLOW,GNOME5(GNOME_YELLOW_R),GNOME5(GNOME_YELLOW_G),GNOME5(GNOME_YELLOW_B));
	ret |= wrefresh(curscr);
	if(ret == OK){
		modified_colors = 1;
	}
